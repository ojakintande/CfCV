...
#++ Real-life
#++++++Penalized L1
StudL1T = c(1.30,1.82,1.75)
InsL1T = c(0.58,1.13,1.11)
StudL1Te = c(0.94,1.97,1.61)
InsL1Te = c(0.49,1.14,1.07)

names(StudL1T) = c('CfCV','HoldOut','V-fold')
names(InsL1T) = c('CfCV','HoldOut','V-fold')
names(StudL1Te) = c('CfCV','HoldOut','V-fold')
names(InsL1Te) = c('CfCV','HoldOut','V-fold')


Stud = rbind(StudL1T,StudL1Te)
Ins = rbind(InsL1T,InsL1Te)

Student = c(1.30,1.82,1.75,0.94,1.97,1.61)
Insurance = c(0.58,1.13,1.11,0.49,1.14,1.07)
#++
exdata <- c(rep("Student Performance Training" , 3) , rep("Student Performance Validation" , 3))
exdata2 <- c(rep("Insurance Training" , 3) , rep("Insurance Validation" , 3))
